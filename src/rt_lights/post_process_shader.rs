...
pub(crate) struct RTLPostProcessPlugin;

impl Plugin for RTLPostProcessPlugin {
    fn build(&self, app: &mut App) {
        app.add_plugins((
            ...
            ExtractComponentPlugin::<RTLPostProcessSettings>::default(),
            // The settings will also be the data used in the shader.
            // This plugin will prepare the component for the GPU by creating a uniform buffer
            // and writing the data to that buffer every frame.
            UniformComponentPlugin::<RTLPostProcessSettings>::default(),
        ));
...
impl ViewNode for PostProcessNode {
    ...
    fn run(
        ...
        let settings_uniforms = world.resource::<ComponentUniforms<RTLPostProcessSettings>>();
            ...
            .queue_render_pipeline(RenderPipelineDescriptor {
                ...
                fragment: Some(FragmentState {
                    ...
                    targets: vec![Some(ColorTargetState {
                        ...
                        //format: TextureFormat::Rgba16Float, // for hdr
                        blend: None,
...
pub struct RTLPostProcessSettings {
    pub something: f32
}