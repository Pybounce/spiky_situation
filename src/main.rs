...
fn main() {
    ...
    App::new()
        ...
        .add_systems(PreUpdate, (reset_player_inputs, handle_gamepad_connections, handle_player_gamepad_input, handle_player_keyboard_input).chain())
