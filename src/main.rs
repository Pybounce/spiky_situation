...
fn main() {
    ...
    App::new()
        ...
        .add_systems(Update, check_gateways)
        .add_event::<PlayerCollisionStarted>()
        .add_event::<PlayerCollisionEnded>()
        .add_systems(PreUpdate, (raise_player_collision_started, raise_player_collision_ended))
        .run();
